...
public class Datos {
	...
	/**
	 * Se instancia el objeto 'dato' de la clase Scanner para recoger los inputs por
	 * teclados de tipo '<b>String</b>'. <br>
	 * También se suprime el aviso tipo <i>Warning</i> por no cerrar el objeto
	 * Scanner.
	 * 
	 ...
	 *            teclado.
	 * @return La función <i>recogeString()</i> con sobrecarga para crear el objeto
	 *         scanner.
	 * @throws Exception
	 */
	...
	/**
	 * Se instancia el objeto 'dato' de la clase Scanner para recoger los inputs por
	 * teclados de tipo '<b>entero</b>'. <br>
	 * También se suprime el aviso tipo <i>Warning</i> por no cerrar el objeto
	 * Scanner.
	 * 
	 ...
	 * @param msg Se le introduce un mensaje personalizado para pedir la entrada del
	 *            teclado.
	 * @return La función <i>recogeInt()</i> con sobrecarga para crear el objeto
	 *         scanner.
	 * @throws Exception
	 */
	...
	/**
	 * Se instancia el objeto 'dato' de la clase Scanner para recoger los inputs por
	 * teclados de tipo '<b>double</b>'. <br>
	 * También se suprime el aviso tipo <i>Warning</i> por no cerrar el objeto
	 * Scanner.
	 * 
	 ...
	 * @param msg Se le introduce un mensaje personalizado para pedir la entrada del
	 *            teclado.
	 * @return La función <i>recogeDouble()</i> con sobrecarga para crear el objeto
	 *         scanner.
	 * @throws Exception
	 */
